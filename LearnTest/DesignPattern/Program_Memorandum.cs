#region  <<版本注释>>
/* ========================================================== 
// <copyright file="Program_Memorandum.cs" company="Shiji.BO.CS">
// Copyright (c) Shiji.BO.CS. All rights reserved.
// </copyright>
* 功能描述：Program_Memorandum  备忘录模式
* 创 建 者：Coden.Liu 
* 创建时间：2020/4/13 14:13:13 
* =============================================================*/
#endregion
using System;
...
namespace Learn.Console.DesignPattern
{
    /// <summary>
    /// 联系人
    /// </summary>
    ...
    public class MobileOwner
    {
        ...
        public void Show()
        {
            System.Console.WriteLine("联系人列表中有{0}个人，他们是:", ContactPersons.Count);
            foreach (ContactPerson p in ContactPersons)
            {
               System.Console.WriteLine("姓名: {0} 号码为: {1}", p.Name, p.MobileNum);
            }
        }
    }
    ...
    class Program_Memorandum:IMain
    {
